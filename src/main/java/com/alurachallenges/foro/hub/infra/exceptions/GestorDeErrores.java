package com.alurachallenges.foro.hub.infra.exceptions;
...
public class GestorDeErrores {
    ...
    @ExceptionHandler(ValidarDuplicadoException.class)
    public ResponseEntity tratarErrorDeValidacion(ValidarDuplicadoException e){
